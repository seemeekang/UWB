...
def compute_ip_tag(og_anchor_coordinates, og_anchor_distance_matrix, og_tag_coordinates):
    dmin = 0.3
    robust_tri_trilaterate_count  = 3

    # cal_anchor_coordinates = compute_RTRR(og_anchor_distance_matrix, dmin, robust_tri_trilaterate_count)
    robust_nodes, trilaterated_robust_node_data, rtrr_node_coordinate, cal_anchor_coordinates = compute_RTRR(
        og_anchor_distance_matrix, dmin, robust_tri_trilaterate_count)
...
def main():
    ...
    cal_a_crdnt, MSE_dist_a, MSE_loc_a, CSR, cal_t_crdnt, MSE_loc_t = compute_ip_tag(
            og_anchor_coordinates, og_anchor_distance_matrix, og_tag_coordinates)
    

    n_cal_a_crdnt, n_MSE_dist_a, n_MSE_loc_a, n_CSR, n_cal_t_crdnt, n_MSE_loc_t = compute_ip_tag(
